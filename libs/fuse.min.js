  ...
  (t = function () {
    ...
    function A(e) {
      ...
      if (m(e) || g(e)) (r = e), (t = I(e)), (n = C(e));
        ...
        var c = e.name;
        if (((r = c), O.call(e, "weight") && (i = e.weight) <= 0)) throw new Error(_(c));
            ...
            },
            {
              ...
              value: function (e, t) {
                ...
                this.keys.forEach(function (t, i) {
                  ...
                  if (x(o))
                    if (g(o)) {
                      for (var c = [], a = [{nestedArrIndex: -1, value: o}]; a.length; ) {
                        var s = a.pop(),
                          u = s.nestedArrIndex,
                          h = s.value;
                        if (x(h))
    ...
    function T(e, t, n) {
      ...
      if (t.length > W) throw new Error("Pattern length exceeds max of ".concat(W, "."));
      for (
        var m,
          k = t.length,
          M = e.length,
        ...
        var _ = N(t, {currentLocation: m, expectedLocation: b, distance: a, ignoreLocation: p});
